...
it('generates DTOs for nested schema references', function (): void {
...
it('generates DTOs with correct property references', function (): void {
    $specFile = sample_path('nested-refs.yml');
    $parser = OpenApiParser::build($specFile);
    $spec = $parser->parse();
...
it('handles circular references gracefully', function (): void {
