...
it('parses headers from postman collection', function (): void {
...
it('handles endpoints without headers in postman collection', function (): void {
    $parser = PostmanCollectionParser::build(__DIR__ . '/../../Samples/test-headers-postman.json');
    $apiSpec = $parser->parse();
...
it('generates postman collection code with headers correctly', function (): void {
    $parser = PostmanCollectionParser::build(__DIR__ . '/../../Samples/test-headers-postman.json');
    $apiSpec = $parser->parse();
